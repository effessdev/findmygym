  ...
  return (
    <div className="mx-auto flex flex-col gap-4 px-4 py-8">
      {gymCount === 0 ? (
        <Card>
          <CardHeader>
            <CardTitle>Welcome to out partnership program</CardTitle>
            <CardDescription>
              You can submit <i>your</i> gym to our app. We will handle
              discovery and payment for you, so you can focus on your job
              better!
            </CardDescription>
          </CardHeader>
          <CardContent>
