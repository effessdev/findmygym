...
- Do not add custom components in `@/components` as it is reserved for shadcn/ui. Custom components should be kept in a `_components` folder in the same directory.
